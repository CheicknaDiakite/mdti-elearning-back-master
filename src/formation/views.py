...
from formation.models import Categorie, SousCategorie, Formation, Cour, Chapitre, Discution, Temoignage, Video, \
    VideoVue, SeanceTravail, Qcm, Question, Reponse, Examen, ResultatExamen
        ...
        if "apprenant_id" in form and "formation_slug" in form and "message" in form and "envoyer_par_apprenant" in form:
            ...
            if apprenant:
                ...
                if formation:
                    ...
                    if len(tmp_cour) > 0:
                        new_discution = Discution(apprenant=apprenant, formation=formation, message=message, envoyer_par_apprenant=envoyer_par_apprenant)
                        new_discution.save()
